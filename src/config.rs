...
pub const FRAME_STEP_PLAYER_PIXELS: f32 = PLAYER_SPEED / TARGET_REFRESH_HZ;
pub const FRAME_STEP_PLAYER_SLOW_PIXELS: f32 = PLAYER_SLOW_SPEED / TARGET_REFRESH_HZ;
pub const FRAME_STEP_BACKGROUND_PIXELS: f32 = BACKGROUND_SCROLL_SPEED / TARGET_REFRESH_HZ;
