...
pub const PLAYER_LEAN_FRAME_SECONDS: f32 = 0.12;
pub const DEFAULT_STRESS_SPRITE_COUNT: usize = 0;
pub const STRESS_SPRITE_DRAW_SCALE: f32 = 1.0;
pub const STRESS_SPRITE_GRID_GAP: f32 = 4.0;
pub const STRESS_SPRITE_LAYER_OFFSET: f32 = 3.0;
...
// Assets.
pub const ASSET_BG_TEST: &str = "assets/br_01.png";
...
pub const HUD_TEXT_X: f32 = 24.0;
pub const HUD_TEXT_FIRST_BASELINE: f32 = 34.0;
pub const HUD_LINE_HEIGHT: f32 = 26.0;
pub const HUD_ROW_TOP_OFFSET: f32 = 7.0;
pub const HUD_ROW_HEIGHT: f32 = 24.0;
pub const HUD_ROW_INSET_X: f32 = 6.0;
pub const HUD_ROW_ACCENT_WIDTH: f32 = 5.0;
pub const HUD_BACKGROUND_HEIGHT: f32 = 144.0;
...
pub const DIAG_PASS_MAX_OVER_TARGET_MS: f32 = 0.7;
pub const DIAG_PASS_P99_OVER_TARGET_MS: f32 = 0.7;
...
pub const FRAME_SLOW_MARKER_FACTOR: f32 = 1.25;
pub const FRAME_FAST_MARKER_FACTOR: f32 = 0.75;
...
pub const HUD_PANEL_COLOR: Color = Color::new(0.0, 0.0, 0.0, 0.58);
pub const HUD_STATUS_ROW_COLOR: Color = Color::new(0.05, 0.08, 0.14, 0.82);
pub const HUD_SCENE_ROW_COLOR: Color = Color::new(0.04, 0.12, 0.10, 0.82);
pub const HUD_SYNC_ROW_COLOR: Color = Color::new(0.11, 0.08, 0.15, 0.82);
pub const HUD_FRAME_ROW_COLOR: Color = Color::new(0.13, 0.10, 0.05, 0.82);
pub const HUD_STABLE_ROW_COLOR: Color = Color::new(0.09, 0.09, 0.10, 0.82);
pub const HUD_STATUS_ACCENT_COLOR: Color = Color::new(0.16, 0.48, 1.0, 1.0);
pub const HUD_SCENE_ACCENT_COLOR: Color = Color::new(0.10, 0.78, 0.46, 1.0);
pub const HUD_SYNC_ACCENT_COLOR: Color = Color::new(0.80, 0.45, 1.0, 1.0);
pub const HUD_FRAME_ACCENT_COLOR: Color = Color::new(1.0, 0.70, 0.18, 1.0);
pub const HUD_STABLE_ACCENT_COLOR: Color = Color::new(0.78, 0.82, 0.90, 1.0);
